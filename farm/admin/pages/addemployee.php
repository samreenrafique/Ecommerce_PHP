...
<body>
    ...
    if(isset($_POST["emp"])){
     ...
     if($img_size <= 1000000){
        ...
        $inser_emp="INSERT INTO `tbl_employee`(`emp_name`,`emp_email`,`emp_add`,`emp_num`,`emp_gender`,`emp_salary`,`emp_dep`,`emp_password`,`emp_img`) 
        VALUES ('$em_name','$em_mail','$em_address','$em_ph','$em_gender','$em_salary','$em_dep','$em_pass','$_loc_img')";
